...
The @fmtdate@ and @fmttime@ attributes of @mka_ical@ control how the placeholders {start_date}, {end_date} and {start_time} and {endtime} are formatted for the entire calendar.
Use this tag to output a date with a custom date or time format using the date formatting parameters of "strftime":http://php.net/manual/en/function.strftime.php.
